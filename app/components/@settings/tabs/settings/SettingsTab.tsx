...
export default function SettingsTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      <motion.div
        className="bg-gray-900 rounded-lg shadow-sm dark:shadow-none p-4 space-y-4"
      ...
      {/* Timezone */}
      <motion.div
        className="bg-gray-900 rounded-lg shadow-sm dark:shadow-none p-4"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between p-2 rounded-lg bg-gray-800">
            ...
            <div className="flex items-center gap-1">
              <kbd className="px-2 py-1 text-xs font-semibold text-bolt-elements-textSecondary bg-gray-700 border border-gray-600 rounded shadow-sm">
