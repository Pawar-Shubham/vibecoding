    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        ...
        >
          ...
          <DropdownMenu.Item 
            className="text-sm rounded-md flex items-center h-8 px-3 py-4 text-gray-800 dark:text-bolt-elements-textPrimary hover:bg-gray-100 dark:hover:bg-bolt-elements-button-secondary-backgroundHover cursor-pointer transition-colors"
