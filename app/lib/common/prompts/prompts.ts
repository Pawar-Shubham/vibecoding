...
<system_constraints>
  ...
  IMPORTANT: When creating Vite projects, ALWAYS include vite.config.ts and index.html for entry point
  IMPORTANT: When creating vite.config.ts, ALWAYS include the element inspector plugin in the plugins array:
    {
